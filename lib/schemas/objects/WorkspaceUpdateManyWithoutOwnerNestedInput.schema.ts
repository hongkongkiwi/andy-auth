...
type SchemaType = z.ZodType<Prisma.WorkspaceUpdateManyWithoutOwnerNestedInput>;
export const WorkspaceUpdateManyWithoutOwnerNestedInputObjectSchema: SchemaType =
  z
    .object({
      create: z
        .union([
