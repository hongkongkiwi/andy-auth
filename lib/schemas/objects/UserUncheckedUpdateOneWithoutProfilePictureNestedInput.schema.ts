...
type SchemaType =
  z.ZodType<Prisma.UserUncheckedUpdateOneWithoutProfilePictureNestedInput>;
export const UserUncheckedUpdateOneWithoutProfilePictureNestedInputObjectSchema: SchemaType =
  z
    .object({
      create: z
        .union([
