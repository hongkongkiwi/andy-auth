...
type SchemaType =
  z.ZodType<Prisma.WorkspaceUncheckedCreateNestedManyWithoutOwnerInput>;
export const WorkspaceUncheckedCreateNestedManyWithoutOwnerInputObjectSchema: SchemaType =
  z
    .object({
      create: z
        .union([
